...
def nejkratsi_vzdalenost(sirka:int, delka:int, predni:int, zadni:int):
    """Upravte tuto funkci"""

    zleva = delka + predni + zadni
    zprava = delka + sirka-predni+sirka-zadni  # Vypočítejte cestu zprava
    
    return min (zleva,zprava)
